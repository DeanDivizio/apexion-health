...
export default function HRTDrawer() {
    ...
    return(
        <Drawer open={open} onOpenChange={setOpen}>
            <DrawerTrigger className="rounded bg-gradient-to-r from-green-500 to-green-700 font-thin hover:font-light p-px flex items-center justify-center transition-all ease-in-out duration-300"><span className="bg-black w-full px-8 sm:px-12 py-2 rounded text-2xl">Log Hormone Treatment</span></DrawerTrigger>
