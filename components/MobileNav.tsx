...
export default function MobileNav() {
    ...
    return(
        <nav className="w-full h-12 flex items-center justify-around fixed bottom-0 md:hidden bg-slate-950/45 backdrop-blur-xl">
            <Link href="/" className="flex justify-center"><House /></Link>
            <Link href="/" className="flex justify-center"><Syringe /></Link>
            ...
            <Link href="/" className="flex justify-center"><Dumbbell /></Link>
