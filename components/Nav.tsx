...
export default function Nav() {
    ...
    return (
        <div className="sticky md:hidden top-0 z-50 grid grid-cols-4 lg:grid-cols-3 w-full justify-between items-center px-8 py-4 lg:py-6 bg-black bg-opacity-25 backdrop-blur-xl">
