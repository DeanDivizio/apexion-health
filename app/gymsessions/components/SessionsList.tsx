...
import { EditableSessionContent } from "./EditableSessionContent"
import { parseSessionDateTime, spellOutDateShortYear } from "./helpers"
...
export function SessionsList() {
  ...
  const deleteSession = deleteConfirmId
    ? sortedSessions.find((s) => s.id === deleteConfirmId)
    : null
